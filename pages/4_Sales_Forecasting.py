...
def perform_forecasting(ARIMA_df, forecast_steps):
    ...
    return plt, future_dates, forecast
...
if uploaded_file is not None:
    ...
    forecast_plot, future_dates, forecast_values = perform_forecasting(data, forecast_days)
    st.pyplot(forecast_plot)

    st.subheader('Forecasted Sales for Each Day:')
